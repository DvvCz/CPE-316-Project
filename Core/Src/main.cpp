...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOA, TS_CS_Pin|LD2_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOC, TS_SCK_Pin|TS_MOSI_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : TS_CS_Pin LD2_Pin */
  GPIO_InitStruct.Pin = TS_CS_Pin|LD2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

  /*Configure GPIO pins : TS_SCK_Pin TS_MOSI_Pin */
  ...
  /*Configure GPIO pin : TS_MISO_Pin */
